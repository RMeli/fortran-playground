...
contains
   ...
   subroutine pdsygst_test
      ...
      if (rank == 0) then
         write (error_unit, *) 'pdsygst average execution time: ', avg_time/numprocs, ' seconds'
         write (error_unit, *) 'pdsygst max execution time: ', max_time, ' seconds'
         write (error_unit, *) 'pdsygst min execution time: ', min_time, ' seconds'
      end if
